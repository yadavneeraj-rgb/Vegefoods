...
<head>
  <title>@yield('title' ?? "Neeraj E-Commerce")</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="{{ asset('web-assets/css/open-iconic-bootstrap.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('web-asset/css/magnific-popup.css') }}">

  <link rel="stylesheet" href="{{ asset('web-assets/css/aos.css') }}">

  <link rel="stylesheet" href="{{ asset('web-assets/css/ionicons.min.css') }}">

  <link rel="stylesheet" href="{{ asset('web-assets/css/bootstrap-datepicker.css') }}">
  <link rel="stylesheet" href="{{ asset('web-assets/css/jquery.timepicker.css') }}">
...
<body class="goto-here">
  ...
  <script src="{{ asset('web-assets/js/jquery-migrate-3.0.1.min.js') }}"></script>
  ...
  <script src="{{ asset('web-assets/js/jquery.animateNumber.min.js')}}"></script>
  <script src="{{ asset('web-assets/js/bootstrap-datepicker.js')}}"></script>
  <script src="{{ asset('web-assets/js/scrollax.min.js')}}"></script>
  <script
