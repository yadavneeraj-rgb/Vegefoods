...
@section("title","Dashboard | Neeraj - Ecommerce")
                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="align-self-center overflow-hidden me-auto">
                                                <div>
                                                    <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);"
                                                            class="text-dark">Project discussion with
                                                            team</a></h5>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted">If several languages coalesce, the grammar of
                                            the resulting of the individual</p>
                                        <div>
                    ...
                    <div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="py-2">
                                    <h5 class="font-size-14">California <span class="float-end">78%</span>
                                    </h5>
                                    ...
                                    <div class="flex-grow-1">
                                        <div>
                                            Posted <span class="fw-semibold">Beautiful Day with
                                                Friends</span> blog... <a href="javascript: void(0);">View</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="javascript: void(0);"
                                                class="text-dark">Riding bike on
                                                road</a></h5>
                                        <p class="text-muted mb-0">24 Oct, 2020</p>
                                    </td>
